...
def run_beam_search_test(
    ...
    for output_obj, expected_outs in zip(outputs, expected_outputs):
        ...
        for output_text, expected_text in zip(output_texts, expected_outs):
...
QWEN2VL_MODEL_PATH = "/workspace/wxz/cache/modelscope/Qwen/Qwen2-VL-2B-Instruct"
QWEN25VL_MODEL_PATH = "/workspace/wxz/cache/modelscope/Qwen/Qwen2.5-VL-3B-Instruct"
QWEN3VL_MODEL_PATH = "/workspace/wxz/cache/modelscope/Qwen/Qwen3-VL-4B-Instruct"
