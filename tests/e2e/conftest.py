...
def ilama_lora_files():
    return "/mnt/lv_model/npu60005420a/qy/modelscope/models/vllm-ascend/ilama-text2sql-spider"
...
def llama32_lora_files():
    ...
    return "/mnt/lv_model/npu60005420a/qy/modelscope/models/jeeejeee/llama32-3b-text2sql-spider"


@pytest.fixture(scope="session")
def qwen2vl_lora_files():
    return "/mnt/lv_model/npu60005420a/qy/modelscope/models/vllm-ascend/qwen2-vl-lora-pokemon"


@pytest.fixture(scope="session")
def qwen25vl_lora_files():
    return "/mnt/lv_model/npu60005420a/qy/modelscope/models/vllm-ascend/qwen25-vl-lora-pokemon"


@pytest.fixture(scope="session")
def qwen25vl_vision_lora_files():
    return "/workspace/wxz/cache/modelscope/vllm-ascend/qwen2.5-3b-vl-lora-vision-connector"


@pytest.fixture(scope="session")
def qwen3vl_vision_lora_files():
    return "/workspace/wxz/cache/modelscope/vllm-ascend/qwen3-4b-vl-lora-vision-connector"


@pytest.fixture(scope="session")
def qwen2vl_language_lora_files():
    return "/workspace/wxz/cache/modelscope/vllm-ascend/qwen2vl-flickr-lora-language"


@pytest.fixture(scope="session")
def qwen2vl_vision_tower_connector_lora_files():
    return "/workspace/wxz/cache/modelscope/vllm-ascend/qwen2vl-flickr-lora-tower-connector"


@pytest.fixture(scope="session")
def qwen2vl_vision_tower_lora_files():
    return "/workspace/wxz/cache/modelscope/vllm-ascend/qwen2vl-flickr-lora-tower"
